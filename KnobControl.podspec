...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Rahul Karanjit" => "rahul.karanjit@cellcom.net.np" }
  # Or just: spec.author    = "Aashish Karn"
  # spec.authors            = { "Aashish Karn" => "aashish.karn@cellcom.net.np" }
  # spec.social_media_url   = "https://twitter.com/Aashish Karn"
  ...
  spec.source       = { :git => "https://github.com/raulkaranjit/KnobControl.git", :tag => "1.0.0" }
